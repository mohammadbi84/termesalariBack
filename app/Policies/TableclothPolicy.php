...
class TableclothPolicy
{
     ...
     * @return mixed
     */
    public function update(User $user, Tablecloth $tablecloth)
    {
        return $user->isAdmin();
    }
     ...
     * @return mixed
     */
    public function restore(User $user, Tablecloth $tablecloth)
    {
        return $user->isAdmin();
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Tablecloth $tablecloth)
    {
        return $user->isAdmin();
    }
