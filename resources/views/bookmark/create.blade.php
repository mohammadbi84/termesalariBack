                ...
                <div class="card-body">
                    ...
                    <form class="form" role="form" action="{{ route('bookmark.store') }}" method="post"
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group @error('title_fa') is-invalid @enderror">
                                    ...
                                    <input type="text" name="title_fa" id="title_fa" class="form-control"
                                        placeholder="لطفا عنوان صفحه را وارد کنید." value="{{ old('title_fa') }}">
                                    @error('title_fa')
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group @error('title_en') is-invalid @enderror">
                                    ...
                                    <input type="text" name="title_en" id="title_en" class="form-control"
                                        placeholder="لطفا عنوان صفحه را وارد کنید." value="{{ old('title_en') }}">
                                    @error('title_en')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group @error('body_fa') is-invalid @enderror">
                            ...
                            <textarea name="body_fa" id="body_fa" class="form-control" rows="5">{{ old('body_fa') }}</textarea>
