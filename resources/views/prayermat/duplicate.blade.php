...
@section('title','پنل مدیریت |ایجاد محصول سجاده و جانماز')
	...
	<div class="col-12">
	    ...
	    <div class="card">
	      <div class="card-header">
	        <h3 class="card-title"><span>سجاده و جانماز جدید</span></h3>
	      </div>
	      <!-- /.card-header -->
	      <!-- form start -->
	      {{-- @dump($errors) --}}
	      <form role="form" id="insertForm" action="{{ route('prayermat.store') }}" method="POST" enctype="multipart/form-data">
	      	@csrf
	        <div class="card-body">
