...
<div class="row">
	<div class="col-12">
	    ...
	    <div class="card">
	      ...
	      <!-- /.card-header -->
	      <!-- form start -->
	      <form class="createForm" role="form" action="{{route('prayermat.store')}}" method="POST" enctype="multipart/form-data">
	      	@csrf
	        ...
	        <div class="card-body">
                ...
                <div class="form-group">
					...
					<textarea name="e_contains" id="e_contains" class="form-control @error('e_contains') is-invalid @enderror" rows="3" placeholder="مثلا شامل یک رومیزی  مربع و دو رومیزی عسلی">{{old('e_contains')}}</textarea>
                ...
                <div class="form-group">
					...
					<textarea name="ar_contains" id="ar_contains" class="form-control @error('ar_contains') is-invalid @enderror" rows="3" placeholder="مثلا شامل یک رومیزی  مربع و دو رومیزی عسلی">{{old('ar_contains')}}</textarea>
                ...
                <div class="form-group">
					...
					<textarea name="e_dimensions" id="e_dimensions" class="form-control @error('e_dimensions') is-invalid @enderror" rows="3" placeholder="ابعاد محصول مثلاً رومیزی مربع با ابعاد 100 * 100 سانتیمتر  &#13;&#10;رومیزی عسلی با ابعاد 50 * 100 سانتیمتر">{{old('e_dimensions')}}</textarea>
					@error('e_dimensions')
					    <div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
				...
				<div class="form-group">
                    ...
                    <select name="kind" id="kind" class="form-control @error('kind') is-invalid @enderror">
                    	{{-- <option value="">جنس محصول را انتخاب کنید .</option> --}}
                      	<option  @if (old('kind') == 'ابریشم مصنوعی (ویسکوز ریون)') selected @endif value="ابریشم مصنوعی (ویسکوز ریون)">ابریشم مصنوعی (ویسکوز ریون)</option>
				...
				<div class="form-group">
					...
					<input type="text" name="kindOfEster" id="kindOfEster" class="form-control @error('kindOfEster') is-invalid @enderror" placeholder="مثلاً ساتن مرغوب" value="{{old('kindOfEster', 'ساتن مرغوب')}}"  >
					@error('kindOfEster')
					    <div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
                <div class="form-group">
					...
					<input type="text" name="e_kindOfEster" id="e_kindOfEster" class="form-control @error('e_kindOfEster') is-invalid @enderror" placeholder="مثلاً ساتن مرغوب" value="{{old('e_kindOfEster', 'ساتن مرغوب')}}"  >
					@error('e_kindOfEster')
					    <div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
                <div class="form-group">
					...
					<input type="text" name="ar_kindOfEster" id="ar_kindOfEster" class="form-control @error('ar_kindOfEster') is-invalid @enderror" placeholder="مثلاً ساتن مرغوب" value="{{old('ar_kindOfEster', 'ساتن مرغوب')}}"  >
