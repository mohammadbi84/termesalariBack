            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                ...
                <div class="col order-lg-1 mb-2">
                    ...
                    <ul class="product-specs ">
                        <li> کد محصول: {{ $prayermat->code }}</li>
                        <li> تعداد رنگ بافت ترمه: {{ $prayermat->color_design->design->countOfColor }} رنگ</li>
                        <li> مشتمل بر: {{ $prayermat->contains }}</li>
                        <li> رنگ: {{ $prayermat->color_design->color->color }}</li>
                    </ul>
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <div class="categories-tags">
                        <div class="action-buttons">
                            ...
                            <a href="#"
                                class="d-block wishlist-btn favorites-btn @if ($prayermat->favorites->where('user_id', Auth::id())->count() > 0) active @endif"
                                data-image="{{ asset('/storage/images/thumbnails/' . $prayermat->images->first()->name) }}"
                                data-moddel="{{ substr($prayermat->category->model, 4) }}"
                                data-design="{{ $prayermat->color_design->design->title ?? '' }}"
                                data-color="{{ $prayermat->color_design->color->color ?? '' }}"
                        ...
                        <div class="stock-info">
                            ...
                            @endif --}}
                            <span class="text-bold">{{ $prayermat->quantity }} عدد موجود می باشد .</span>
                        </div>
