...
@section('title','فروشگاه ترمه سالاری | محصولات سجاده و جانماز')
  ...
  <div class="row mt-4 mb-4">
    ...
    <div class="col-lg-9 col-md-6 col-sm-12">
      ...
      <div class="row card">
        <!-- <div class="col-md-12"> -->
          <div class="card-header position-relative">
            <div class="card-title">
              <span><a href="{{ route('homeStore.index') }}">صفحه اصلی فروشگاه</a> / محصولات سجاده و جانماز{{-- ( {{ $prayermats->count() }} کالا) --}}</span>
                    ...
                    <div class="box-product">
                      <a href="{{ route('prayermat.show',[$prayermat]) }}" >
                        <div class="img-wrapper mb-2">
                          @if(count($prayermat->images) > 0)
                            <img alt="Product" src="{{ asset('/storage/images/thumbnails/'.$prayermat->images->sortby('ordering')->first()->name) }}" class="w-100">
                          @else
        ...
        @if($prayermats->count() > 15)
          <div class="" style="margin: 20px auto;">{{ $prayermats->links() }}</div>
        @endif
      </div>
...
@push("js")
  ...
  <script src="{{asset('/storetemplate/dist/js/filter-prayermat.js')}}"></script>
