    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card col-md-12 col-sm-12">
                ...
                <div class="card-body">
                    <form class="form" role="form" action="{{ route('post.store') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="لطفا عنوان را وارد کنید." value="{{ old('title') }}">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price" id="price"
                                ...
                                placeholder="لطفا هزینه ارسال را وارد کنید." value="{{ old('price') }}">
                            @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_time" id="delivery_time"
                                ...
                                placeholder="لطفا زمان ارسال را وارد کنید." value="{{ old('delivery_time') }}">
                            @error('delivery_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
