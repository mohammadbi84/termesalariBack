        ...
        <div class="input-group-append">
          <button class="btn btn-navbar" type="submit">
            ...
            <ul class="navbar-nav mr-auto">
                @if (Auth::check())
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#">
                            {{ Auth::user()->name }} {{ Auth::user()->family }}&nbsp;<i class="fa fa-chevron-down"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="{{ route('userMessage.index') }}"
                        title=" نوتیفیکیشن ها">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
                        @if ($countNotification > 0)
                            ...
                            @if (isset($countUserMessages) and $countUserMessages > 0)
                                <div class="dropdown-divider"></div>
                                <a href="{{ route('userMessage.index') }}" class="dropdown-item"
                            ...
                            @if (isset($countMessages) and $countMessages > 0)
                                ...
                                <a href="{{ route('userMessage.index') }}" class="dropdown-item"
                                    style="font-size: 0.9rem">
                                    <i class="fa fa-paper-plane ml-2"></i> {{ $countMessages }} پیام جدید از
                                    بازدیدکنندگان
                                    {{-- <span class="float-left text-muted text-sm">3 دقیقه</span> --}}
                                </a>
                            @endif
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link cart" href="{{ route('order.index') }}" title="سفارش ها">
                        ...
                        @if (isset($countOrders) and $countOrders > 0)
                            <span
                                class="badge badge-danger navbar-badge shopping-cart-badge">{{ $countOrders }}</span>
                        @endif
                    </a>
                </li>
                        ...
                        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                            <div class="image">
                                <a href="#" data-toggle="modal" data-target="#profileImages">
                                    <img src="@if (Auth::user()->image) {{ asset('/storetemplate/dist/img/' . Auth::user()->image) }}@else{{ asset('/storetemplate/dist/img/avatar7.jpg') }} @endif?s=200&amp;d=mm&amp;r=g"
                                        class="img-circle elevation-2" alt="User Image">
                                </a>
                            </div>
                            <div class="info">
                                <a href="{{ route('user.adminProfile') }}" class="d-block">
                                    @if (Auth::check())
                                ...
                                <div class="modal-body row">
                                    @for ($i = 7; $i <= 12; $i++)
                                        <div class="col-4 mb-3">
                                            <a href="{{ route('user.adminChangeImage', ['avatar' . $i . '.jpg']) }}"
                                                class=""><img class="profile-user-img img-fluid img-circle"
                                                    src="{{ asset('/storetemplate/dist/img/avatar' . $i . '.jpg') }} "
