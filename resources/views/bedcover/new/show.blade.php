                ...
                <div class="col-lg-7 order-lg-1 mb-2 rounded-3 p-2">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex justify-content-start align-items-center gap-2" style="margin-top: 10px;">
                            ...
                            <a href="#" id="compare" data-bs-toggle="tooltip" data-bs-placement="top" title="برای مقایسه کلیک کنید" class="share-btn telegram" data-image="{{ asset('/storage/images/thumbnails/' . $bedcover->images->first()->name) }}"
                            ...
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="افزودن به لیست علاقه‌مندی ها" class="share-btn telegram  favorites-btn @if ($bedcover->favorites->where('user_id', Auth::id())->count() > 0) active @endif"
