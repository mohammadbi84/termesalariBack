...
@section('title','فروشگاه ترمه سالاری | محصولات روتخت')
  ...
  <div class="row mt-4 mb-4">
    ...
    <div class="col-lg-9 col-md-6 col-sm-12">
      ...
      <div class="row card">
        <!-- <div class="col-md-12"> -->
          <div class="card-header position-relative">
            <div class="card-title">
              <span><a href="{{ route('homeStore.index') }}">صفحه اصلی فروشگاه</a> / محصولات روتختی {{-- ( {{ $bedcovers->count() }} کالا) --}}</span>
        ...
        @if($bedcovers->count() > 15)
          <div class="" style="margin: 20px auto;">{{ $bedcovers->links() }}</div>
        @endif
      </div>
...
@push("js")
  ...
  <script src="{{asset('/storetemplate/dist/js/filter-bedcover.js')}}"></script>
