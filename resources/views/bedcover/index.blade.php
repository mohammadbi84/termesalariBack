                        ...
                        <tbody>
                            ...
                            @foreach ($bedcovers as $key => $bedcover)
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input type="checkbox" data-value = "{{ $bedcover->id }}"
                                    ...
                                    <td>
                                        @if ($bedcover->images->first())
                                            ...
                                            <img src="{{ asset('storage/images/thumbnails/' . $bedcover->images->first()->name) }}"
                                    ...
                                    <td>
                                        <div class="br-wrapper br-theme-fontawesome-stars float-left">
                                            ...
                                            <select class="showGrade{{ $key }}"
                                                data-value="{{ $bedcover->grades->avg('grade') ?? '0' }}">
