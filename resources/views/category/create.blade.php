    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card col-md-12 col-sm-12">
                ...
                <div class="card-body">
                    {{-- {{ dd($products) }} --}}
                    <form class="form" role="form" action="{{ route('category.store') }}" method="post"
                        ...
                        <div class="form-group @error('parent_id') is-invalid @enderror">
                            ...
                            <select name="parent_id" id="parent_id" class="form-control" style="width: 100%;">
                                ...
                                @foreach ($products as $product)
                                    <option value="{{ $product->id }}" @if ('{{ $product->id }}' == old('parent_id')) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="لطفا عنوان زیر محموعه دسته بندی را وارد کنید." value="{{ old('title') }}">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="e_title" id="e_title"
                                ...
                                placeholder="لطفا عنوان انگلیسی زیر محموعه دسته بندی را وارد کنید."
                                value="{{ old('e_title') }}">
                            @error('e_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            <label for="ar_title">عنوان عربی زیر مجموعه</label>
