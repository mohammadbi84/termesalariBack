        ...
        <div class="col-md-12" style="margin: 0 auto;">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <span id="title"><a href="{{ route('tablecloth.storeIndex') }}" style="color: #18d26e;">محصولات
                                رومیزی</a> / {{ $tablecloth->category->title }} طرح
                            {{ $tablecloth->color_design->design->title }} رنگ
                            {{ $tablecloth->color_design->color->color }}</span>
                        ...
                        <div class="owl-carousel owl-theme" id="slideshow" style=" width:100%;">
                            @foreach ($images as $key => $image)
                                ...
                                <a href="{{ asset('storage/images/' . $image['name']) }}">
                                    <img class="w-100 zoom" src="{{ asset('storage/images/' . $image['name']) }}"
                                        alt="{{ $image['name'] }}">
                                </a>
                    ...
                    <div class="mt-3" style="width: 320px; margin: auto auto;">
                        <div class="card card-sale card-danger card-outline ">
                            ...
                            <div class="card-body">
                                ...
                                <p>
                                <div class="row">
                                    <input @if ($tablecloth->quantity > 0) id="addToCart" @endif type="submit"
                                        value="افزودن به سبد خرید"
                                        class="btn btn-block btn-danger btn-lg @if ($tablecloth->quantity == 0) disabled @endif"
                                ...
                                <div class="br-wrapper br-theme-fontawesome-stars">
                                    امتیاز :
                                    <select id="showGrade" data-model="Tablecloth" data-current-rating="4">
                                        <!-- now hidden -->
                                ...
                                <a href="#" id="addToFavorite" data-id="{{ $tablecloth->id }}"
                                    data-model="Tablecloth" class="float-left mt-1" title="افزودن به لیست علاقه مندی ها"
                                    style="font-size: 1.5rem"><i
                                        class="@if ($tablecloth->favorites->where('user_id', Auth::id())->count() > 0) fa fa-heart @else far fa-heart @endif"></i></a>

                                <a href="" id="compare" title="افزودن به لیست مقایسه"
                                    class="float-left ml-2 mt-2" data-id="{{ $tablecloth->id }}" data-model="Tablecloth"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <table class="table table-striped table-data">
                                <tr>
                                    <th colspan="2" style="color: #ef3a4e;">{{ $tablecloth->category->title }} طرح
                                        {{ $tablecloth->color_design->design->title }} رنگ
                                        {{ $tablecloth->color_design->color->color }}</th>
                                </tr>
                                <tr>
                                    <td>کد محصول</td>
                        ...
                        <div class="tab-pane" id="tab_2">
                            ...
                            <div class="br-wrapper br-theme-fontawesome-stars" style="margin-bottom: 20px;">
                                ...
                                <select id="setGrade" data-model="Tablecloth" data-id="{{ $tablecloth->id }}">
                                    <!-- now hidden -->
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                @if (Auth::check())
                                    <form action="" method="">
                                        ...
                                        <div class="img-push">
                                            ...
                                            <br>
                                            <input type="submit" id="saveComment" data-model="Tablecloth"
                                                data-id="{{ $tablecloth->id }}" value="ثبت" class="btn btn-danger">
                                        </div>
                                    </form>
                                @else
                                    ...
                                    <div class="box-product">
                                        <a href="{{ route('tablecloth.show', [$likeTablecloth->id]) }}">
                                            <div class="img-wrapper mb-2">
                                                <img alt="Product"
                                                    src="{{ asset('/storage/images/thumbnails/' . $likeTablecloth->images->sortby('ordering')->first()->name) }}"
                                                    class="w-100">
                                            </div>
                                        </a>
                                        ...
                                        <h6>
                                            <a href="{{ route('tablecloth.show', [$likeTablecloth->id]) }}"
                                                class="title">{{ $likeTablecloth->category->title }} طرح
                                                {{ $likeTablecloth->color_design->design->title }} رنگ
                                                {{ $likeTablecloth->color_design->color->color }}</a>
                                        </h6>
                                        <div class="price">
                                            @php
                                        ...
                                        <div style="clear: both;">
                                            ...
                                            @endif
                                            <small
                                                @if ($likeTablecloth->quantity > 5) style="color: #000" @else style="color: #ef3a4e" @endif>
                                                @if ($likeTablecloth->quantity == 0)
                                                    اتمام موجودی در انبار
                                                @elseif($likeTablecloth->quantity <= 5)
