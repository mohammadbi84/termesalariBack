        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('tablecloth.create') }}"
                        ...
                        <tbody>
                            ...
                            @foreach ($tablecloths as $key => $tablecloth)
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input type="checkbox" data-value = "{{ $tablecloth->id }}"
                                    ...
                                    <td>
                                        <div class="br-wrapper br-theme-fontawesome-stars float-left">
                                            ...
                                            <select class="showGrade{{ $key }}"
                                                data-value="{{ $tablecloth->grades->avg('grade') ?? '0' }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('tablecloth.duplicate', [$tablecloth]) }}"
                                            class="btn btn-outline-secondary btn-flat btn-sm"><i
                                                class="fas fa-copy"></i> کپی </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('amazing.index', ['model' => 'Tablecloth', 'id' => $tablecloth->id]) }}"
                                            target="blank" class="btn btn-outline-danger btn-sm"> مشاهده </a>
                                    </td>
                                    <td><a href="{{ route('tablecloth.show', [$tablecloth]) }}" target="blank"
                                            class="btn btn-outline-info btn-flat btn-sm"><i
                                                class="fas fa-info-circle"></i> جزئیات </a></td>
                                    <td><a href="{{ route('tablecloth.edit', [$tablecloth]) }}"
                                            class="btn btn-outline-primary btn-flat btn-sm"><i class="fas fa-edit"></i>
                                            ویرایش </a></td>
                                    <td><a href="{{ route('comment.product', ['Tablecloth', $tablecloth->id]) }}"
                                            class="btn btn-outline-primary btn-flat btn-sm"><i
                                                class="fas fa-comment"></i> نظرات </a></td>

                                    <td>
                                        <form class="del-form"
                                            action="{{ route('tablecloth.destroy', [$tablecloth]) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="#" data-id="{{ $tablecloth->id }}" data-model="Tablecloth"
