            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span
                            class="tag">{{ app()->getLocale() == 'fa' ? $tablecloth->color_design->design->title : $tablecloth->color_design->design->e_title }}</span>
                    </div>
                    ...
                    <div class="splide" id="hot_slider" role="group" aria-label="Splide Basic HTML Example">
                        <div class="splide__track py-3">
                            <ul class="splide__list">
                                @foreach ($likeTablecloths as $key => $tablecloth)
                                    @php
                                        $prices = $tablecloth->prices->where('local', 'تومان')->first();
                                    @endphp
                                    @php
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center gap-2">
                                                        <button
                                                            ...
                                                            style="width:30px;height:30px"><i
                                                                class="@if ($tablecloth->favorites->where('user_id', Auth::id())->count() > 0) fa-solid @else fa-regular @endif fa-heart text-danger"></i></button>
                                                        <button
