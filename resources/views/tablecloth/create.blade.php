	      ...
	      <form class="createForm" role="form" action="{{route('tablecloth.store')}}" method="POST" enctype="multipart/form-data">
	        ...
	        <div class="card-body">
                ...
                <div class="form-group">
					...
					<textarea name="e_uses" id="e_uses" class="form-control @error('e_uses') is-invalid @enderror" rows="3" placeholder="مثلاً رومیزی، روی پشتی، روی تاقچه، سفره زینتی و ...">{{old('e_uses')}}</textarea>
                ...
                <div class="form-group">
					...
					<textarea name="ar_uses" id="ar_uses" class="form-control @error('ar_uses') is-invalid @enderror" rows="3" placeholder="مثلاً رومیزی، روی پشتی، روی تاقچه، سفره زینتی و ...">{{old('ar_uses')}}</textarea>
