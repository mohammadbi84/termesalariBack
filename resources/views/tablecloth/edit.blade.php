        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><span>ویرایش محصول {{ $tablecloth->category->title }} طرح
                            {{ $tablecloth->color_design->design->title }} رنگ
                            {{ $tablecloth->color_design->color->color }}</span></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {{-- @dump($errors) --}}
                <form role="form" id="editForm" action="{{ route('tablecloth.update', [$tablecloth]) }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                                placeholder="کد محصول را وارد کنید ." value="{{ old('code', $tablecloth->code) }}"
                                autofocus="autofocus">
                            @error('code')
                        ...
                        <div class="form-group @error('category_id') is-invalid @enderror">
                            ...
                            <select name="category_id" id="category_id"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" @if ($category->id == old('category_id', $tablecloth->category->id)) selected @endif>
                        ...
                        <div class="form-group @error('design_id') is-invalid @enderror">
                            ...
                            <select name="design_id" id="design_id" class="form-control select2 select2-hidden-accessible "
                                ...
                                @foreach ($designs as $design)
                                    <option @if (old('design_id', $tablecloth->color_design->design->id) == $design->id) selected @endif value="{{ $design->id }}">
                                        {{ $design->title }}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <select name="color_id" id="color_id"
                                ...
                                @foreach ($colors as $color)
                                    <option @if (old('color_id', $tablecloth->color_design->color->id) == $color->id) selected @endif value="{{ $color->id }}">
                                        {{ $color->color }}</option>
                                @endforeach
                            </select>
                            @error('color_id')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="contains" class="form-control @error('contains') is-invalid @enderror" rows="3"
                                placeholder="مثلا شامل یک رومیزی  مربع و دو رومیزی عسلی">{{ old('contains', $tablecloth->contains) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="e_contains" class="form-control @error('e_contains') is-invalid @enderror" rows="3"
                                placeholder="مثلا شامل یک رومیزی  مربع و دو رومیزی عسلی">{{ old('e_contains', $tablecloth->e_contains) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="e_dimensions" class="form-control @error('e_dimensions') is-invalid @enderror" rows="3"
                                placeholder="ابعاد محصول مثلاً رومیزی مربع با ابعاد 100 * 100 سانتیمتر  &#13;&#10;رومیزی عسلی با ابعاد 50 * 100 سانتیمتر">{{ old('e_dimensions', $tablecloth->e_dimensions) }}</textarea>
                            @error('e_dimensions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kind" class="form-control @error('kind') is-invalid @enderror">
                                ...
                                <option @if (old('kind', $tablecloth->kind) == 'ابریشم مصنوعی (ویسکوز ریون)') selected @endif
                                    value="ابریشم مصنوعی (ویسکوز ریون)">ابریشم مصنوعی (ویسکوز ریون)</option>
                                <option @if (old('kind', $tablecloth->kind) == 'ابریشم مصنوعی') selected @endif value="ابریشم مصنوعی">ابریشم
                                    مصنوعی</option>
                            </select>
                            @error('kind')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="e_kind" id="e_kind"
                                ...
                                {{-- <option value="">جنس محصول را انتخاب کنید .</option> --}}
                                <option @if (old('e_kind', $tablecloth->e_kind) == 'Rayon (viscose rayon)') selected @endif value="Rayon (viscose rayon)">
                                    Rayon (viscose rayon)</option>
                                <option @if (old('e_kind', $tablecloth->e_kind) == 'Artificial silk') selected @endif value="Artificial silk">
                        ...
                        <div class="form-group">
                            ...
                            <select name="sewingType" class="form-control @error('sewingType') is-invalid @enderror">
                                ...
                                <option @if (old('sewingType', $tablecloth->sewingType) == 'مغزی دوزی') selected @endif value="مغزی دوزی">مغزی دوزی
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="e_sewingType" id="e_sewingType"
                                ...
                                {{-- <option value="">نوع دوخت را انتخاب کنید .</option> --}}
                                <option @if (old('e_sewingType', $tablecloth->e_sewingType) == 'Bind') selected @endif value="Bind">Bind</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="e_haveEster" id="e_haveEster"
                                ...
                                {{-- <option value="">آنتخاب ویژگی آستر</option> --}}
                                <option @if (old('e_haveEster', $tablecloth->e_haveEster) == 'Yes') selected @endif value="Yes">Yes</option>
                                <option @if (old('e_haveEster', $tablecloth->e_haveEster) == 'No') selected @endif value="No">No</option>
                            </select>
                            @error('e_haveEster')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="washable" class="form-control @error('washable') is-invalid @enderror">
                                ...
                                <option @if (old('washable', $tablecloth->washable) == 'توسط دست') selected @endif value="توسط دست">توسط دست
                                </option>
                                <option @if (old('washable', $tablecloth->washable) == 'دارد ( ترجیحا خشکشویی)') selected @endif value="دارد ( ترجیحا خشکشویی)">
                        ...
                        <div class="form-group">
                            ...
                            <select name="e_washable" id="e_washable"
                                ...
                                <option @if (old('e_washable', $tablecloth->e_washable) == 'By hand')  @endif value="By hand">By hand</option>
                                <option @if (old('e_washable', $tablecloth->e_washable) == 'Yes (preferably dry cleaning)') selected @endif
                                    value="Yes (preferably dry cleaning)">Yes (preferably dry cleaning)</option>
                                <option @if (old('e_washable', $tablecloth->e_washable) == 'No Washing') selected @endif value="No Washing">No Washing
                                </option>
                            </select>
                            @error('e_washable')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="uses" class="form-control @error('uses') is-invalid @enderror" rows="3"
                                placeholder="مثلاً رومیزی، روی پشتی، روی تاقچه، سفره زینتی و ...">{{ old('uses', $tablecloth->uses) }}</textarea>
                        ...
                        <div class="form-group">
                            <label for="e_uses">موارد استفاده انگلیسی</label>
                            <textarea name="e_uses" class="form-control @error('e_uses') is-invalid @enderror" rows="3"
                            ...
                            <div class="prices-{{ $key + 1 }} @if ($key == 1 or $key == 2) mt-4 pt-4 @endif "
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2" style="text-align: left;margin: auto;">
                                        @if ($key == 0 or $key == 1)
                                            <a href="#"
                                                class="btn btn-flat btn-secondary addPrice @if ($key == 0 and $tablecloth->prices->count() > 1 or $key == 1 and $tablecloth->prices->count() > 2) d-none @else d-inline-block @endif "
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="offPrice[]"
                                                ...
                                                {{-- @if (old('offPrice.' . $key, $prices->offPrice) == '' and old('offType.' . $key) == '') disabled @else enabled @endif --}}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quantity"
                                ...
                                value="{{ old('quantity', $tablecloth->quantity) }}">
                            @error('quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                placeholder="توضیحات ، نکات و ویژگی های بیشتر در رابطه به محصول">{{ old('description', $tablecloth->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="e_description" class="form-control @error('e_description') is-invalid @enderror" rows="3"
                                placeholder="توضیحات ، نکات و ویژگی های بیشتر در رابطه به محصول">{{ old('e_description', $tablecloth->e_description) }}</textarea>
                            @error('e_description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
        ...
        let tags = @json($tablecloth->tags->pluck('name')->values());
        ...
        $(function() {
            ...
            $("#store").click(function() {
                ...
                if (totalFilesCount == 0) {
                    ...
                    var c = $("#images").parents(".form-group").find(".invalid-feedback").text(
                        "پر کردن فیلد تصاویر محصول الزامی می باشد.");
                    // .css("display","block")
                    event.preventDefault();
                }
            ...
            if (design_id != "") {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            $('#color_id').html('<option value="" >رنگ محصول را انتخاب کنید .</option>')
                                .trigger("change");

                            data.forEach((element) => {
                                if ("{{ old('color_id', $tablecloth->color_design->color->id) }}" ==
                                    element.id)
                                    var newOption = new Option(element.color, element.id, false,
                                        true);
                                else
                                    var newOption = new Option(element.color, element.id, false,
                                        false);
                ...
                if (id != "") {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.length > 0) {
                                $('#color_id').append(
                                    '<option value="">رنگ محصول را انتخاب کنید .</option>');
                                data.forEach((element) => {
                                    $('#color_id').append("<option value='" + element
                                        .id + "'>" + element.color + "</option>");
                                });
                            } else {
                                alert(
                                    "این طرح فاقد اطلاعات رنگ بندی می باشد .بنابراین امکان استفاده از این طرح وجود ندارد ."
            ...
            $('.addPrice').click(function() {
                ...
                $thiz.hide();
                if (value == "prices-2") {
                    $(".prices-1").find(".addPrice").addClass("d-none").removeClass("d-inline-block")
                        .fadeIn("fast");
                    $(".prices-2").find(".delPrice").addClass("d-inline-block").removeClass("d-none")
                        .fadeIn("fast");
                    $(".prices-2").find(".addPrice").addClass("d-inline-block").removeClass("d-none")
                        .fadeIn("fast");
                }
                if (value == "prices-3") {
                    // $(".prices-2").find(".delPrice").addClass("d-none").removeClass("d-inline-block").fadeOut("fast");
                    $(".prices-2").find(".addPrice").addClass("d-none").removeClass("d-inline-block")
                        .fadeOut("fast");
                }
            ...
            $('.delPrice').click(function() {
                ...
                if (c == 2)
                    ...
                    $("." + value).find(".offType").children("option[value='']").attr("selected",
                        "selected");
                    $("." + value).find(".offPrice").attr("disabled", "disabled");
                    if (value == "prices-2") {
                        $(".prices-1").find(".addPrice").addClass("d-inline-block").removeClass("d-none")
                            .fadeIn("fast");
                    }
                    if (value == "prices-3") {
