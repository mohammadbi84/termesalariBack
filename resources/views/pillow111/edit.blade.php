	...
	<div class="col">
	    ...
	    <div class="card">
	      <div class="card-header">
	        <h3 class="card-title"><span>ویرایش  محصول  {{ $pillow->category->title}} طرح {{$pillow->color_design->design->title}} رنگ {{$pillow->color_design->color->color}}</span></h3>
	      </div>
	      <!-- /.card-header -->
	      <!-- form start -->
	      {{-- @dump($errors) --}}
	      <form role="form" id="editForm" action="{{route('pillow.update',[$pillow])}}" method="POST" enctype="multipart/form-data">
	      	@csrf
	      	@method('put')
	        <div class="card-body">
