    ...
    <div class="card-body register-card-body">
      ...
      <form action="{{ route('register') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input name="name" id="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="نام"  value="{{ old('name') }}"  autofocus>
        ...
        <div class="input-group mb-3">
          <input name="family" id="family" type="text" class="form-control @error('family') is-invalid @enderror" placeholder="نام خانوادگی"  value="{{ old('family') }}" >
          <div class="input-group-append">
        ...
        <div class="input-group mb-3">
          <input name="mobile" id="mobile" type="mobile" maxlength="11" class="form-control @error('mobile') is-invalid @enderror" placeholder="شماره موبایل " value="{{ old('mobile') }}"  >
          <div class="input-group-append">
        ...
        <div class="input-group mb-3">
          <input name="email" id="email" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="آدرس ایمیل" value="{{ old('email') }}"  >
          <div class="input-group-append">
