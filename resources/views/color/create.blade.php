				...
				<div class="card-body">
					<form class="form" role="form" action="{{ route('color.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<input type="text" name="e_color" id="e_color1" class="form-control @error('color') is-invalid @enderror" placeholder="لطفا عنوان انگلیسی رنگ را وارد کنید." value="{{old('e_color')}}">
							@error('e_color')
							    <div class="invalid-feedback">{{$message}}</div>
							@enderror
						</div>
                        <div class="form-group">
							...
							<input type="text" name="ar_color" id="ar_color1" class="form-control @error('color') is-invalid @enderror" placeholder="لطفا عنوان انگلیسی رنگ را وارد کنید." value="{{old('ar_color')}}">
							@error('ar_color')
							    <div class="invalid-feedback">{{$message}}</div>
							@enderror
						</div>
