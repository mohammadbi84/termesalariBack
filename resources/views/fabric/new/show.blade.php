...
@section('title', $title . __('products.design') . (app()->getLocale() == 'fa' ?
    $fabric->color_design->design->title : $fabric->color_design->design->e_title) . __('products.color') .
    (app()->getLocale() == 'fa' ? $fabric->color_design->color->color : $fabric->color_design->color->e_color))
@section('head')
    @if (app()->getLocale() == 'fa')
            ...
            <div class="row rounded-4 shadow-sm bg-white px-4 mb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('fabric.storeIndex') }}"
                                class="text-decoration-none text-muted">{{ __('products.fabric_products') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ app()->getLocale() == 'fa' ? $fabric->category->title : $fabric->category->e_title }}
                            {{ __('products.design') }}
                            {{ app()->getLocale() == 'fa' ? $fabric->color_design->design->title : $fabric->color_design->design->e_title }}
                            {{ __('products.color') }}
                            {{ app()->getLocale() == 'fa' ? $fabric->color_design->color->color : $fabric->color_design->color->e_color }}
                        </li>
                    </ol>
            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex justify-content-start align-items-center gap-2" style="margin-top: 10px;">
                            ...
                            <a href="#" id="compare" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-model="{{ substr($fabric->category->model, 4) }}">
                                <i class="fa-solid fa-shuffle"></i>
                            </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="{{ __('product.wishlist') }}"
                                class="share-btn telegram  favorites-btn @if ($fabric->favorites->where('user_id', Auth::id())->count() > 0) active @endif"
                                data-image="{{ asset('/storage/images/thumbnails/' . $fabric->images->first()->name) }}"
                                data-moddel="{{ substr($fabric->category->model, 4) }}"
                                data-design="{{ app()->getLocale() == 'fa' ? $fabric->color_design->design->title : $fabric->color_design->design->e_title ?? '' }}"
                                data-color="{{ app()->getLocale() == 'fa' ? $fabric->color_design->color->color : $fabric->color_design->color->e_color ?? '' }}"
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <ul class="product-specs ">
                        <li>{{ __('product.product_code') }}: {{ $fabric->code }}</li>
                        <li>
                            {{ __('product.color_count') }}:
                            {{ $fabric->color_design->design->countOfColor }}
                            {{ __('product.colors') }}
                        </li>
                        <li>{{ __('product.contains') }}: {{ app()->getLocale() == 'fa' ? $fabric->contains : $fabric->e_contains }}</li>
                        <li>{{ __('product.color') }}:
                            {{ app()->getLocale() == 'fa' ? $fabric->color_design->color->color : $fabric->color_design->color->e_color }}
                        </li>
                    </ul>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('fabric.storeIndex') }}"
                            class="tag">{{ app()->getLocale() == 'fa' ? $fabric->category->title : $fabric->category->e_title }}</a>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="color-title">{{ __('product.tags') }} :</h6>
                        <span
                            class="tag">{{ app()->getLocale() == 'fa' ? $fabric->color_design->design->title : $fabric->color_design->design->e_title }}</span>
                    </div>
                    <div class="categories-tags">
                        ...
                        <div class="stock-info">
                            ...
                            <span class="text-bold">
                                {{ __('product.available_qty', ['count' => $fabric->quantity]) }}
                            </span>
                        </div>
                        <div class="quantity-control">
                            <div class="quantity-controls gap-2">
                                <button class="minus-btn" data-model="{{ substr($fabric->category->model, 4) }}"
                                    data-id="{{ $fabric->id }}">-</button>
                                <span class="count item-quantity-product" id="item-quantity-product">1</span>
                                <button class="plus-btn" data-model="{{ substr($fabric->category->model, 4) }}"
                                    data-id="{{ $fabric->id }}">+</button>
                            </div>
                            <button class="btn btn-primary @if ($fabric->quantity != 0) addToCart @endif"
                                data-image="{{ asset('/storage/images/thumbnails/' . $fabric->images->first()->name) }}"
                                data-id="{{ $fabric->id }}"
                                data-moddel="{{ substr($fabric->category->model, 4) }}"
                                data-design="{{ app()->getLocale() == 'fa' ? $fabric->color_design->design->title : $fabric->color_design->design->e_title ?? '' }}"
                ...
                <div class="col p-0">
                    <div class="bg-white rounded-4 p-4 shadow-sm mb-4">
                        ...
                        <p class="text-justify text-muted">
                            {{ app()->getLocale() == 'fa' ? $fabric->description : $fabric->e_description }}
                        </p>
                    </div>
                    <div class="bg-white rounded-4 p-4 shadow-sm">
                        ...
                        <form action="/comment" method="POST" class="">
                            @csrf
                            <input type="hidden" name="product" value="{{ $fabric->id }}">
                            <input type="hidden" name="model" value="Fabric">
                            <div class="mb-4">
                    ...
                    <ul class="list-group list-group-flush p-0">
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->dimensions : $fabric->e_dimensions }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.weight') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->weight : $fabric->e_weight }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.material') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->kind : $fabric->e_kind }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.sewing_type') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->sewingType : $fabric->e_sewingType }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->haveEster : $fabric->e_haveEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining_material') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->kindOfEster : $fabric->e_kindOfEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.washable') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->washable : $fabric->e_washable }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.uses') }}</span>
                                <span class="point-span">{{ app()->getLocale() == 'fa' ? $fabric->uses : $fabric->e_uses }}</span>
                            </div>
                        </li>
                    </ul>
                </div>
            </div>
            @if ($likeFabrics->count() > 0)
                    ...
                    <div class="splide" id="hot_slider" role="group" aria-label="Splide Basic HTML Example">
                        <div class="splide__track py-3">
                            <ul class="splide__list">
                                @foreach ($likeFabrics as $key => $fabric)
                                    @php
                                        $prices = $fabric->prices->where('local', 'تومان')->first();
                                    @endphp
                                    @php
                                            ...
                                            <div class="hot-product-card">
                                                ...
                                                <div class="overlay">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="
                                                            @switch($fabric->category->model)
                                                                @case('App\Tablecloth')
                                                                  {{ route('fabric.show', [$fabric->id]) }}
                                                                  @break
                                                                @case('App\Pillow')
                                                                  {{ route('fabric.show', [$fabric->id]) }}
                                                                  @break
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center gap-2">
                                                        <button
                                                            class="buy-button shadow-none add-to-cart favorites-btn @if ($fabric->favorites->where('user_id', Auth::id())->count() > 0) active @endif"
                                                            data-image="{{ asset('/storage/images/thumbnails/' . $fabric->images->first()->name) }}"
                                                            data-moddel="{{ substr($fabric->category->model, 4) }}"
                                                            data-design="{{ app()->getLocale() == 'fa' ? $fabric->color_design->design->title : $fabric->color_design->design->e_title ?? '' }}"
                                                            data-color="{{ app()->getLocale() == 'fa' ? $fabric->color_design->color->color : $fabric->color_design->color->e_color ?? '' }}"
                                                            ...
                                                            style="width:30px;height:30px"><i
                                                                class="@if ($fabric->favorites->where('user_id', Auth::id())->count() > 0) fa-solid @else fa-regular @endif fa-heart text-danger"></i></button>
                                                        <button
                                                            class="buy-button shadow-none add-to-cart @if ($fabric->quantity != 0) addToCart @endif"
        ...
        $(document).ready(function() {
            ...
            $('#share-btn').click(function(e) {
                ...
                if (navigator.share) {
                    navigator.share({
                        title: "{{ $fabric->title }}",
                        text: "مشترک عزیز، این محصول را ببینید: {{ $fabric->title }}",
                        url: "{{ url()->current() }}"
