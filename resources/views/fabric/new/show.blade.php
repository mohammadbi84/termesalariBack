...
@section('title', $title . __('products.design') . ($fabric->color_design->design->title) . __('products.color') .
            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex justify-content-start align-items-center gap-2" style="margin-top: 10px;">
                            ...
                            <a href="#" id="compare" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-title="{{ $fabric->category->title }}"
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span
                            class="tag">{{ $fabric->color_design->design->title }}</span>
                    </div>
                    ...
                    <ul class="list-group list-group-flush p-0">
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->dimensions }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->weight }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->kind }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->sewingType }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->haveEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->kindOfEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->washable }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span
                                    class="point-span">{{ $fabric->uses }}</span>
                            </div>
                        </li>
                    </ul>
                </div>
            </div>
            @if ($likeFabric->count() > 0)
                    ...
                    <div class="splide" id="hot_slider" role="group" aria-label="Splide Basic HTML Example">
                        <div class="splide__track py-3">
                            <ul class="splide__list">
                                @foreach ($likeFabric as $key => $fabric)
                                    @php
                                        $prices = $fabric->prices->where('local', 'تومان')->first();
                                    @endphp
                                    @php
                                                ...
                                                <div class="hot-image-container">
                                                    <a
                                                        ...
                                                        @switch($fabric->category->model)
                                                                @case('App\Tablecloth')
                                                                  {{ route('tablecloth.show', [$fabric->id]) }}
                                                                  @break
                                                                @case('App\Pillow')
