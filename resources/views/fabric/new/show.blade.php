...
@section('title', $title . ' طرح ' . $fabric->color_design->design->title . ' رنگ ' .
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ $fabric->category->title }} طرح {{ $fabric->color_design->design->title }} رنگ
                            {{ $fabric->color_design->color->color }}
                        </li>
                    </ol>
                </nav>
            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex justify-content-start align-items-center gap-2" style="margin-top: 10px;">
                            ...
                            <a href="#" id="compare" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-design="{{ $fabric->color_design->design->title ?? '' }}"
                                data-color="{{ $fabric->color_design->color->color ?? '' }}"
                                data-title="{{ $fabric->title }}" data-price="{{ $prices->price }}"
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <ul class="product-specs ">
                        ...
                        <li>{{ __('product.contains') }}: {{ $fabric->contains }}</li>
                        <li>{{ __('product.color') }}: {{ $fabric->color_design->color->color }}</li>
                    </ul>
                    <hr>
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="color-title">{{ __('product.category') }} :</h6>
                        <a href="{{ route('fabric.storeIndex') }}"
                            class="tag">{{ $fabric->category->title }}</a>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="color-title">{{ __('product.tags') }} :</h6>
                        <span class="tag">{{ $fabric->color_design->design->title }}</span>
                    </div>
                    ...
                    <ul class="list-group list-group-flush p-0">
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="point-span">{{ $fabric->dimensions }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.weight') }}</span>
                                <span class="point-span">{{ $fabric->weight }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.material') }}</span>
                                <span class="point-span">{{ $fabric->kind }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.sewing_type') }}</span>
                                <span class="point-span">{{ $fabric->sewingType }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining') }}</span>
                                <span class="point-span">{{ $fabric->haveEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining_material') }}</span>
                                <span class="point-span">{{ $fabric->kindOfEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.washable') }}</span>
                                <span class="point-span">{{ $fabric->washable }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.uses') }}</span>
                                <span class="point-span">{{ $fabric->uses }}</span>
                            </div>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <div class="hot-product-card">
                                                ...
                                                <div class="overlay">
                                                    <h3 class="product-title">
                                                        ...
                                                        رنگ
                                                        {{ $fabric->color_design->color->color }}</h3>
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            @switch($fabric->category->model)
                                                                @case('App\fabric')
                                                                  ...
                                                                  @break
                                                                @case('App\Pillow')
                                                                  {{ route('pillow.show', [$fabric->id]) }}
                                                                  @break
                                                                @case('App\Prayermat')
                                                                  {{ route('prayermat.show', [$fabric->id]) }}
                                                                  @break
                                                                @case('App\Bedcover')
                                                                  {{ route('bedcover.show', [$fabric->id]) }}
                                                                  @break
                                                                @case('App\Shoe')
