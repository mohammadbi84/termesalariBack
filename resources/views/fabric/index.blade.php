                        ...
                        <tbody>
                            ...
                            @foreach ($fabrics as $key => $fabric)
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input type="checkbox" data-value = "{{ $fabric->id }}"
                                    ...
                                    <td>
                                        <div class="br-wrapper br-theme-fontawesome-stars float-left">
                                            ...
                                            <select class="showGrade{{ $key }}"
                                                data-value="{{ $fabric->grades->avg('grade') ?? '0' }}">
