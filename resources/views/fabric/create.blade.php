...
<div class="row">
	<div class="col">
	    ...
	    <div class="card">
	      ...
	      <!-- /.card-header -->
	      <!-- form start -->
	      <form class="createForm" role="form" action="{{route('fabric.store')}}" method="POST" enctype="multipart/form-data">
	      	@csrf
	        ...
	        <div class="card-body">
				...
				<div class="form-group">
					<label for="dimensions">اندازه عرض پارچه</label>
					<textarea name="dimensions" id="dimensions" class="form-control @error('dimensions') is-invalid @enderror" rows="3" placeholder="">{{old('dimensions','120 سانتیمتر')}}</textarea>
					@error('dimensions')
					    <div class="invalid-feedback">{{$message}}</div>
					@enderror
				</div>
