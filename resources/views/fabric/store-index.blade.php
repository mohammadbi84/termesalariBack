...
@section('title','فروشگاه ترمه سالاری | محصولات پارچه ترمه')
  ...
  <div class="row mt-4 mb-4">
    ...
    <div class="col-lg-9 col-md-6 col-sm-12">
      ...
      <div class="row card">
        <!-- <div class="col-md-12"> -->
          <div class="card-header position-relative">
            <div class="card-title">
              <span><a href="{{ route('homeStore.index') }}">صفحه اصلی فروشگاه</a> / محصولات پارچه ترمه {{-- ( {{ $fabrics->count() }} کالا) --}}</span>
        ...
        @if($fabrics->count() > 15)
          <div class="" style="margin: 20px auto;">{{ $fabrics->links() }}</div>
        @endif
      </div>
...
@push("js")
  ...
  <script src="{{asset('/storetemplate/dist/js/filter-fabric.js')}}"></script>
