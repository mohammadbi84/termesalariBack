...
@section('title','پنل مدیریت |ایجاد محصول پارچه ترمه')
	...
	<div class="col">
	    ...
	    <div class="card">
	      <div class="card-header">
	        <h3 class="card-title"><span>پارچه ترمه جدید</span></h3>
	      </div>
	      <!-- /.card-header -->
	      <!-- form start -->
	      {{-- @dump($errors) --}}
	      <form role="form" id="insertForm" action="{{ route('fabric.store') }}" method="POST" enctype="multipart/form-data">
	      	@csrf
	        <div class="card-body">
