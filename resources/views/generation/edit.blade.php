...
@section('title', 'پنل مدیریت | ویرایش خاندان ترمه سالاری')
            ...
            <div class="card col-md-12 col-sm-12">
                <div class="card-header">
                    <div class="card-title">
                        <span>ویرایش خاندان ترمه سالاری</span>
                    </div>
                </div>
                <div class="card-body">
                    {{-- {{ dd($products) }} --}}
                    <form class="form" role="form" action="{{ route('generation.update', $generation->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 @error('name_fa') is-invalid @enderror">
                                ...
                                <input type="text" name="name_fa" id="name_fa" class="form-control"
                                    placeholder="لطفا نام فارسی را وارد کنید." value="{{ old('name_fa',$generation->name_fa) }}">
                                @error('name_fa')
                            ...
                            <div class="form-group col-md-6 @error('name_en') is-invalid @enderror">
                                ...
                                <input type="text" name="name_en" id="name_en" class="form-control"
                                    placeholder="لطفا نام انگلیسی را وارد کنید." value="{{ old('name_en',$generation->name_en) }}">
                                @error('name_en')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 @error('pretext_fa') is-invalid @enderror">
                                ...
                                <input type="text" name="pretext_fa" id="pretext_fa" class="form-control"
                                    placeholder="لطفا عنوان فارسی را وارد کنید." value="{{ old('pretext_fa',$generation->pretext_fa) }}">
                                @error('pretext_fa')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 @error('pretext_en') is-invalid @enderror">
                                ...
                                <input type="text" name="pretext_en" id="pretext_en" class="form-control"
                                    placeholder="لطفا عنوان انگلیسی را وارد کنید." value="{{ old('pretext_en',$generation->pretext_en) }}">
                                @error('pretext_en')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
