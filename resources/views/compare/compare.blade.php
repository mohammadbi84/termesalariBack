        ...
        <div class="row g-0">
            ...
            @if (session()->has('compares') and count(session('compares')['product']) > 0)
                    ...
                    @foreach (session('compares')['product'] as $compare)
                        <li>
                            <div class="img-compare">
                                <div class="images owl-carousel owl-theme m-auto" style="width: 100px; height: 100px;"
                                    id="slideshow{{ $compare->id }}">
                            ...
                            <a href="{{ route('compare.remove') }}" class="close" data-id="{{ $compare->id }}"><i
                ...
                <ul id="data-compare" class="compare-nav">
                    ...
                    <li class="compare_list_value">
                        @foreach (session('compares')['product'] as $compare)
                            <div class="compareValue{{ $compare->id }}">
                                {{ $compare->color_design->design->countOfColor }} رنگ</div>
                        @endforeach
                    </li>
