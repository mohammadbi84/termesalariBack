...
@section('content')
                                ...
                                <div class="row" style="clear: both;">
                                    @foreach ($recipients as $recipient)
                                        ...
                                        <div class="col-md-5 recipientBox">
                                            <label>
                                                <input type="radio" name="recipient" class="card-input-element"
                                                    @if ($recipient->created_at == $date) checked="checked" @endif
                                                    value="{{ $recipient->id }}" />
                                                <div class="card">
                                                    <div class="card-header">
                                                    ...
                                                    <div class="card-footer">
                                                        ...
                                                        <form class="del-form"
                                                            ...
                                                            @method('delete')
                                                            <a href=""
                                                                class="btn btn-outline-danger btn-flat deleteRecipient">حدف</a>
                                                        </form>
                                                    </div>
                                                </div>
                                            </label>
                            ...
                            <form method="post" action="{{ route('cart.cartfinal') }}" class="col-md-12">
                                    ...
                                    @if ($recipient->created_at == $date)
                                        <div class="col-md-12 recipientAddress"
                                            ...
                                            <div id="selectedRecipientAddress">
                                                {{ $recipient->subcity->city->name }}، {{ $recipient->subcity->name }}،
                                                {{ $recipient->address }}، پلاک {{ $recipient->houseId }}
                                            </div>
                                ...
                                <div class="col-md-12 post" style="border-bottom: 1px solid rgba(0,0,0,.125);">
                                    ...
                                    @foreach ($posts as $post)
                                        <div class="">
                                            <label>
                                                <input type="radio" value="{{ $post->id }}" class="radio"
                                                    name="postType" data-price="{{ $post->price }}" data-widget="collapse"
                                                    data-toggle="tooltip"
    ...
    <div class="modal fade" id="formAddRecipient" tabindex="-1" role="dialog" aria-labelledby="formAddRecipientLabel"
        aria-hidden="true">
            ...
            $("#saveRecipient").click(function(event) {
                ...
                if (city == "") {
                    ...
                    $("#city_id").parents(".form-group").append(
                        '<div class="invalid-feedback" style="display:block;">لطفا نام استان را انتخاب کنید.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (subcity == "") {
                    ...
                    $("#subcity_id").parents(".form-group").append(
                        '<div class="invalid-feedback" style="display:block;">لطفا نام شهر را انتخاب کنید.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (address == "") {
                    ...
                    $("#address").after(
                        '<div class="invalid-feedback">پر کردن فیلد آدرس الزامی می باشد.</div>');
                    return false;
                    event.preventDefault();
                }
                ...
                if (houseId == "" || isNaN(houseId) == true) {
                    ...
                    $("#houseId").after(
                        '<div class="invalid-feedback">پر کردن فیلد پلاک به صورت عددی الزامی می باشد.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (zipcode == "" || isNaN(zipcode) == true || zipcode.length < 10) {
                    ...
                    $("#zipcode").after(
                        '<div class="invalid-feedback">پر کردن فیلد کدپستی به صورت عددی الزامی می باشد.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (name == "") {
                    ...
                    $("#name").after(
                        '<div class="invalid-feedback">پر کردن فیلد نام گیرنده الزامی می باشد.</div>');
                    return false;
                    event.preventDefault();
                }
                ...
                if (family == "") {
                    ...
                    $("#recipientfamily").after(
                        '<div class="invalid-feedback">پر کردن فیلد نام خانوادگی گیرنده الزامی می باشد.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (nationalCode == "" || isNaN(nationalCode) == true || nationalCode.length < 10) {
                    ...
                    $("#nationalCode").after(
                        '<div class="invalid-feedback">پر کردن فیلد کدملی به صورت عددی الزامی می باشد.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                ...
                if (mobile == "" || mobile.length < 11) {
                    ...
                    $("#mobile").after(
                        '<div class="invalid-feedback">پر کردن فیلد موبایل به صورت عددی الزامی می باشد.</div>'
                    );
                    return false;
                    event.preventDefault();
                }
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data.res == "success") {
                                        swal("عملیات با موفقیت انجام شد.", data.message,
                                            data.res);
                                        $thiz.parents('.recipientBox').fadeOut("slow");
                                        var selected = $thiz.parents('.recipientBox').find(
                                            'input[name=recipient]').attr('checked');
                                        if (selected)
