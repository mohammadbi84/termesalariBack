...
@section('title','لیست نمایندگی ها')
	...
	<section class="content">
		...
		<div class="card">
			<div class="card-header">
				<a href="{{ route('agency.create') }}" class="pr-3 pl-3 pt-2 pb-2 btn btn-flat btn-danger float-left " title="نمایندگی جدید">+</a>
				<div class="card-title float-right"><span>نمایندگی ها</span></div>
			</div>
			<div class="card-body">
				<table id="dataTable-table" class="table table-striped display nowrap dataTable" style="width:100%;text-align: center;" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							<td>
		                		<label>
			                    	<input type="checkbox" data-value = "{{ $agency->id }}" class="flat-red checkbox">
			                  	</label>
		                	</td>
							...
							<td>
								<a href="{{route('agency.edit',[$agency])}}" class="btn btn-outline-primary btn-flat btn-sm"><i class="fas fa-edit"></i> ویرایش </a>
							</td>
							<td>
								<form class="del-form" action="{{route('agency.destroy', [$agency])}}" method="post">
									@csrf
									@method('delete')
