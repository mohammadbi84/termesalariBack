...
@section('main-content')
    <section class="content">
        ...
        <div class="card col-md-10 col-sm-12">
            ...
            <form class="form" role="form" action="{{ route('client.update', $client) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="لطفا عنوان  مشتری را وارد کنید." value="{{ old('title', $client->title) }}"
                            maxlength="100">
                        @error('title')
...
<script>
    $(function() {
        ...
        $("#image").fileinput({
            initialPreview: [
                url = "{{ asset('storage/' . $client->image) }}"
            ],
