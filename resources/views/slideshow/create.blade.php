				...
				<form class="form" role="form" action="{{ route('slideshow.store') }}" method="POST" enctype="multipart/form-data">
					<div class="card-body">
		                ...
		                <div class="form-group">
							...
							<input type="text" name="e_title" id="e_title" class="form-control @error('e_title') is-invalid @enderror" placeholder="لطفا عنوان  تصویر را وارد کنید." value="{{old('e_title')}}" maxlength="100">
							@error('e_title')
							    <div class="invalid-feedback">{{$message}}</div>
							@enderror
						</div>
		                <div class="form-group">
							...
							<input type="text" name="ar_title" id="ar_title" class="form-control @error('ar_title') is-invalid @enderror" placeholder="لطفا عنوان  تصویر را وارد کنید." value="{{old('ar_title')}}" maxlength="100">
							@error('ar_title')
							    <div class="invalid-feedback">{{$message}}</div>
							@enderror
						</div>
						...
						<div class="form-group">
							...
							<textarea name="e_description" id="e_description" class="form-control @error('e_description') is-invalid @enderror" placeholder="لطفا توضیحات  تصویر را وارد کنید." maxlength="300">{{ old('e_description') }}</textarea>
							@error('e_description')
							    <div class="invalid-feedback">{{$message}}</div>
							@enderror
						</div>
						<div class="form-group">
							...
							<textarea name="ar_description" id="ar_description" class="form-control @error('ar_description') is-invalid @enderror" placeholder="لطفا توضیحات  تصویر را وارد کنید." maxlength="300">{{ old('ar_description') }}</textarea>
