        ...
        <div class="product-card">
            ...
            <a href="{{ route('pillow.show', [$pillow]) }}">
                <div class="product-img-wrapper">
                    <img src="{{ asset('/storage/images/thumbnails/' . $pillow->images->sortby('ordering')->first()->name) }}"
                        alt="">
                ...
                <div class="product-price w-100 d-flex justify-content-between align-items-center mb-2">
                    <div class="d-flex flex-grow-1 align-items-center justify-content-start gap-1">
                        <div class="text-center cell-div">
                            <span class="sell-count d-block">{{ $pillow->orderitems->sum('count') }}</span>
                            <span class="sell-text">{{ __('products.sales') }}</span>
                        </div>
                        <div class="text-center">
                            @php
                                $score =
                                    $pillow->comments()->sum('score') /
                                    ($pillow->comments()->count() > 0 ? $pillow->comments()->count() : 1);
                            @endphp
                    ...
                    <div class="col-7 p-0 pe-2 py-2 pb-3 bg-white">
                        <div class="row g-0">
                            <div class="col-3 d-flex justify-content-start align-items-center">
                                <button
                                    class="buy-button add-to-cart favorites-btn @if ($pillow->favorites->where('user_id', Auth::id())->count() > 0) active @endif"
                            ...
                            <div class="col-3 d-flex justify-content-start align-items-center">
                                <a href="{{ route('pillow.show', [$pillow->id]) }}" data-bs-toggle="tooltip"
