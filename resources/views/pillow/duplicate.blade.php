...
@section('title', 'پنل مدیریت |ایجاد محصول پشتی و کوسن')
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><span>پشتی و کوسن جدید</span></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {{-- @dump($errors) --}}
                <form role="form" id="insertForm" action="{{ route('pillow.store') }}" method="POST"
