            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                ...
                <div class="col order-lg-1 mb-2">
                    ...
                    <ul class="product-specs ">
                        <li> کد محصول: {{ $pillow->code }}</li>
                        <li> تعداد رنگ بافت ترمه: {{ $pillow->color_design->design->countOfColor }} رنگ</li>
                        <li> مشتمل بر: {{ $pillow->contains }}</li>
                        <li> رنگ: {{ $pillow->color_design->color->color }}</li>
                    </ul>
                ...
                <div class="col order-lg-3 mb-2">
                    ...
                    <div class="categories-tags">
                        ...
                        <div class="stock-info">
                            ...
                            @endif --}}
                            <span class="text-bold">{{ $pillow->quantity }} عدد موجود می باشد .</span>
                        </div>
