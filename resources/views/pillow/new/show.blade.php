...
@section('title', $title . ' طرح ' . $pillow->color_design->design->title . ' رنگ ' .
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            {{ $pillow->category->title }} طرح {{ $pillow->color_design->design->title }} رنگ
                            {{ $pillow->color_design->color->color }}
                        </li>
                    </ol>
                </nav>
            ...
            <div class="row rounded-4 shadow-sm bg-white p-4 mb-5">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex justify-content-start align-items-center gap-2" style="margin-top: 10px;">
                            ...
                            <a href="#" id="compare" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                data-title="{{ $pillow->title }}" data-price="{{ $prices->price }}"
                                data-pay="{{ $price }}" data-off="{{ $off }}"
                                data-offType="{{ $prices->offType }}" data-local="{{ $prices->local }}"
                                data-id="{{ $pillow->id }}"
                                data-model="{{ substr($pillow->category->model, 4) }}">
                ...
                <div class="col order-lg-3 mb-2">
                    <h1 class="product-title">
                        ...
                        {{ $pillow->color_design->design->title }} رنگ
                        {{ $pillow->color_design->color->color }}
                    </h1>
                    <div class="rating">
                        @php
                    ...
                    <ul class="product-specs ">
                        <li>{{ __('product.product_code') }}: {{ $pillow->code }}</li>
                        <li>
                            {{ __('product.color_count') }}:
                            {{ $pillow->color_design->design->countOfColor }}
                            {{ __('product.colors') }}
                        </li>
                        <li>{{ __('product.contains') }}: {{ $pillow->contains }}</li>
                        <li>{{ __('product.color') }}: {{ $pillow->color_design->color->color }}</li>
                    </ul>
                    <hr>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="tag">{{ $pillow->color_design->design->title }}</span>
                    </div>
                    <div class="categories-tags">
                        ...
                        <div class="stock-info">
                            ...
                            <span class="text-bold">
                                {{ __('product.available_qty', ['count' => $pillow->quantity]) }}
                            </span>
                        </div>
                        <div class="quantity-control">
                            <div class="quantity-controls gap-2">
                                <button class="minus-btn" data-model="{{ substr($pillow->category->model, 4) }}"
                                    data-id="{{ $pillow->id }}">-</button>
                                <span class="count item-quantity-product" id="item-quantity-product">1</span>
                                <button class="plus-btn" data-model="{{ substr($pillow->category->model, 4) }}"
                                    data-id="{{ $pillow->id }}">+</button>
                            </div>
                ...
                <div class="col p-0">
                    ...
                    <div class="bg-white rounded-4 p-4 shadow-sm">
                        ...
                        <form action="/comment" method="POST" class="">
                            @csrf
                            <input type="hidden" name="product" value="{{ $pillow->id }}">
                            <input type="hidden" name="model" value="pillow">
                            <div class="mb-4">
                    ...
                    <ul class="list-group list-group-flush p-0">
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="point-span">{{ $pillow->dimensions }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.weight') }}</span>
                                <span class="point-span">{{ $pillow->weight }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.material') }}</span>
                                <span class="point-span">{{ $pillow->kind }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.sewing_type') }}</span>
                                <span class="point-span">{{ $pillow->sewingType }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining') }}</span>
                                <span class="point-span">{{ $pillow->haveEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.lining_material') }}</span>
                                <span class="point-span">{{ $pillow->kindOfEster }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.washable') }}</span>
                                <span class="point-span">{{ $pillow->washable }}</span>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ __('product.uses') }}</span>
                                <span class="point-span">{{ $pillow->uses }}</span>
                            </div>
                        </li>
                    </ul>
                </div>
                                            ...
                                            <div class="hot-product-card">
                                                ...
                                                <div class="overlay">
                                                    <h3 class="product-title">
                                                        ...
                                                        رنگ
                                                        {{ $pillow->color_design->color->color }}</h3>
                                                    <div
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center gap-2">
                                                        <button
                                                            ...
                                                            style="width:30px;height:30px"><i
                                                                class="@if ($pillow->favorites->where('user_id', Auth::id())->count() > 0) fa-solid @else fa-regular @endif fa-heart text-danger"></i></button>
                                                        <button
                                                            class="buy-button shadow-none add-to-cart @if ($pillow->quantity != 0) addToCart @endif"
        ...
        $(document).ready(function() {
            ...
            $('#share-btn').click(function(e) {
                ...
                if (navigator.share) {
                    navigator.share({
                        title: "{{ $pillow->title }}",
                        text: "مشترک عزیز، این محصول را ببینید: {{ $pillow->title }}",
                        url: "{{ url()->current() }}"
