...
<div class="row">
	<div class="col">
	    ...
	    <div class="card">
	      ...
	      <!-- /.card-header -->
	      <!-- form start -->
	      <form class="createForm" role="form" action="{{route('pillow.store')}}" method="POST" enctype="multipart/form-data">
	      	@csrf
				...
				{{-- <div class="form-group">
                    ...
                    <select name="washable" id="washable" class="form-control @error('washable') is-invalid @enderror">
                    	<option value="">قابلیت شستشو</option>
                      	<option @if (old('washable') == 'توسط دست') selected @endif value="توسط دست">توسط دست</option>
						<option @if (old('washable') == 'توسط ماشین لباسشویی') selected @endif value="توسط ماشین لباسشویی">توسط ماشین لباسشویی</option>
