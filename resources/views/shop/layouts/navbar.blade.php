                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <div class="d-flex gap-2 align-items-center justify-content-center position-relative">
                        ...
                        <div class="dropdown" id="cart_dropdown">
                            <a class="text-decoration-none btn btn-icon border-0" id="cartBtn"
                            ...
                            <ul class="dropdown-menu dropdown-animated text-end p-0 pb-1 shadow border-0">
                                <li class="bg-white w-100 d-flex justify-content-between align-items-center g-0"
                                                ...
                                                @php
                                                    ...
                                                    switch ($model) {
                                                        case 'Tablecloth':
                                                            ...
                                                            break;
                                                        // اضافه کردن caseهای دیگر برای مدل‌های مختلف
                                                    }
                                                @endphp

                                                <li class="dropdown-item pb-0 pe-2 cart-item" data-id="{{ $productId }}"
                                                    data-model="{{ $model }}">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="quantity-controls">
                                                                    <a href="#" class="decrease"
                                                                        ...
                                                                        data-id="{{ $productId }}">-</a>
                                                                    <span
                                                                        class="count item-quantity">{{ $quantity }}</span>
                                ...
                                <li class="bg-white p-3 border-top" id="cart-button"
                                    style="position: sticky;bottom: 0;">
                                    <div class="row ">
                                        <div class="col-4 text-start">
                                            <span
                                                class="float-end mt-0 card-price">{{ number_format($price ?? 0) }}<span
