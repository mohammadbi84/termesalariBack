                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ asset('/storetemplate/dist/img/' . $user->image) }}" alt="User profile picture">
                            </div>
                            ...
                            @if ($user->isActive == 1)
                                <div class="alert alert-info text-center" style="padding: 0.5rem 1.25rem;">وضعیت: فعال است
                                </div>
                            @else
                                <div class="alert alert-danger text-center" style="padding: 0.45rem 1.25rem;">وضعیت: غیرفعال
                                    است</div>
                            @endif
                                ...
                                <div id="userDetail" class="container tab-pane active row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 mb-3">
                                            <span class="text-bold">نام و نام خانوادگی:</span> {{ $user->name }}
                                            {{ $user->family }}
                                        </div>
                                        <div class="col-md-6 col-sm-12 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 mb-3">
                                            ...
                                            {{ verta($user->birthday)->format('%d %B، %Y') }}
                                        </div>
                                        <div class="col-md-6 col-sm-12 mb-3">
                                    ...
                                    @if ($user->companyName != '')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 mb-3">
                                                <span class="text-bold">نام شرکت یا سازمان: </span>
                                                {{ $user->companyName }}
                                            </div>
                                            <div class="col-md-6 col-sm-12 mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 mb-3">
                                                <span class="text-bold">شناسه ثبت: </span>
                                            ...
                                            @foreach ($user->comments as $comment)
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        <span
                                                            class="time float-left">{{ verta($comment->created_at)->format('%d %B، %Y') }}<i
                                                                class="fa fa-clock-o mr-1"></i></span>
                                                        ...
                                                        <h3 class="timeline-header"><a href="#">
                                                                ...
                                                                رنگ {{ $comment->commentable->color_design->color->color }}
                                                                با کد {{ $comment->code }}</a></h3>
                                        ...
                                        @if (isset($userMessages) and $userMessages->count() > 0)
                                            ...
                                            @foreach ($userMessages as $userMessage)
                                                ...
                                                <li>
                                                    ...
                                                    <div class="timeline-item">
                                                        <div class="time float-none" style=" height: 1rem"><i
                                                                class="fa fa-clock-o ml-1"></i>{{ verta($userMessage->created_at)->format('%d %B، %Y') }}
                                                        </div>
                                                        <br>
                                                        ...
                                                        <div class="timeline-body"
                                                            style="border-top-color: #ddd;border-top: 1px solid rgba(0,0,0,.125); ">
                                        ...
                                        <div class="card mt-4">
                                            <div class="card-header">
                                                <div class="row p-2" style="font-weight: bold;">
                                                        ...
                                                        @php
                                                            ...
                                                            foreach ($order->orderitems as $orderitem) {
                                                                $sumPay =
                                                                    $sumPay +
                                                                    $orderitem->count *
                                                                        ($orderitem->price - $orderitem->offPrice);
                                                                $sumOff =
                                                                    $sumOff + $orderitem->offPrice * $orderitem->count;
                                                                $sumPrice =
                                                                    $sumPrice + $orderitem->count * $orderitem->price;
                                                            }
                                                            ...
                                                            if ($order->discount_card_id != '') {
                                                                if ($order->discountCard->type == 'price') {
                                                                    ...
                                                                    $sumPay =
                                                                        $sumPay -
                                                                        ($order->discountCard->amount * $sumPrice) /
                                                                            100;
                                                                }
                                                            }
                                                    ...
                                                    <div class="col-md-2 col-sm-12 mb-4 collapse-icon text-danger text-left"
                                                        style="cursor: pointer;" data-toggle="collapse"
                                                        data-target="#order{{ $order->id }}" aria-expanded="true"
                                                        aria-controls="order{{ $order->id }}">
                                                        <div class="link font-weight-normal ml-2">جزئیات <i
                                                                class="fa fa-chevron-down" style="font-size: 0.7rem"></i>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="order{{ $order->id }}" class="card-body collapse"
                                                ...
                                                <table class="table w-10" style="font-size: 95%">
                                                    ...
                                                    @foreach ($order->orderitems as $orderitem)
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format($orderitem->price) }} {{ $order->local }}
                                                            </td>
                                                            <td>{{ number_format($orderitem->offPrice) }}
                                                                {{ $order->local }}</td>
                                                ...
                                                <div class="row mt-4">
                                                    ...
                                                    <div class="col-sm-12 col-md-4 mb-4 text-center">
                                                        <span class="text-bold mb-4">جمع پرداختی به همراه هزینه ارسال
                                                        </span>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9 col-sm-12 mb-4">
                                                            <b>آدرس : </b> {{ $order->recipient->city->name }} -
                                                            {{ $order->recipient->subcity->name }} -
                                                            {{ $order->recipient->address }} - پلاک
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 mb-4">
                                                            <b>هزینه : </b><span>{{ $order->postPrice }}
                                                                {{ $order->local }}</span>
                                                        </div>
                                                        <div class="col-md-4 col-sm-12 mb-4">
                                                            <b>مدت زمان :</b><span> حداکثر
                                                ...
                                                @if ($payment != '')
                                                    <div class="card-header">
                                                        <div class="card-title"><span>اطلاعات پرداخت به روش
                                                                {{ $payment->payment_method->title }}</span></div>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-5 col-sm-12 mb-4">
                                                                <b>شماره ارجاع یا شماره پیگیری :
                                                            ...
                                                            <div class="col-md-3 col-sm-12 mb-4">
                                                                <b>پرداختی : </b><span>{{ number_format($payment->price) }}
                                                                    {{ $order->local }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
