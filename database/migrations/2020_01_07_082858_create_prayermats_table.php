...
class CreatePrayermatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prayermats', function (Blueprint $table) {
            ...
            $table->string('dimensions','300')->comment('ابعاد');
            $table->string('weight','50')->comment('وزن تقریبی');
            $table->string('kind','50')->comment('جنس');
            $table->string('contains','300')->comment('مشتمل بر');
    ...
    {
        Schema::dropIfExists('prayermats');
    }
}
